...
<head>
<title>Eventbaker::Invoice</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<link rel="stylesheet" type="text/css" href="styles/base.css" media="screen" />
<!-- Base Stylesheet do not change or remove -->
<link rel="stylesheet" type="text/css" href="styles/horizon_print.css" media="print" />
<link rel="stylesheet" type="text/css" href="styles/horizon.css" />
<!-- Remove this and add your own invoice styles -->
</head>
<body> 
<div id="invoice"> 
  <div id="invoice-header"> <img alt="Mainlogo_large" class="logo screen" src="images/logo.png" /> 
    <!-- hCard microformat --> 
    <div class="vcard" id="company-address"> 
      <div class="fn org"><strong>EventBaker.com</strong></div> 
      <div class="adr"> 
        <div class="street-address">Street Address line<br/> 
      ...
      <!-- adr --> 
      <div class="email">email@company.com</div> 
  ...
  <!-- #invoice-header --> 
  <div id="invoice-info"> 
    <h2>Invoice <strong><?php echo $_POST['invoice'];?></strong></h2> 
    <h3>21 February 2008</h3> 
    <p id="payment-terms">Payment Terms: 30 days</p> 
    <p id="payment-due">Remaining payment in 2 weeks</p> 
	<p id="payment-total">&#163;<?php echo $_POST['product_amount'];?></p>
  </div> 
  <!-- #invoice-info --> 
  <div class="vcard" id="client-details"> 
    <div class="fn"><?php echo $_POST['payer_fname'];?></div> 
    <div class="org"><?php echo $_POST['payer_email'];?></div> 
    <div class="adr"> 
      <div class="street-address"> <?php echo $_POST['payer_city'];?><br/> 
        <?php echo $_POST['payer_state'];?><br />
<?php echo $_POST['phone'];?> <br/>

      </div> 
      <!-- street-address --> 
      <div class="locality"><?php echo $_POST['payer_country'];?></div> 
      <div id="client-postcode"><span class="region">Region</span> <span class="postal-code"><?php echo $_POST['payer_zip'];?></span></div> 
  ...
  <table id="invoice-amount"> 
    ...
    <tbody> 
      <tr class="item odd"> 
        ...
        <td class="item_l"><?php echo $_POST['product_name'];?></td> 
        <td class="item_r"><?php echo $_POST['product_amount'];?></td> 
