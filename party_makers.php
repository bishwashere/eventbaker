...
<!--here starts modification-->
	 ...
	 <article style="position: relative; width: 100%; opacity: 1;height: 300px;background-image:url('images/pmaker.png');"> 
...
$sql = "SELECT * ".
       "FROM gallery where (category='party_maker')and(itemname like '%$s_key%' or city like '%$s_key%')".
