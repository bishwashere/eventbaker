...
?>
        ...
        <div class="footer">
       	 ...
       	 <div class="footer-bottom">
				...
				<div class="col_1_of_5 span_1_of_5">
					<h3 class="m_9">Beauty parlours N Spa</h3>
					<ul class="list1">
				...
				<div class="col_1_of_5 span_1_of_5">
					...
					<ul class="list1">
					    ...
					    <li><a href="shop.php">wishlists</a></li>
       	 ...
       	 <div class="copy">
       	   <div class="wrap">
       	   	  <p>© All rights reserved | Template by&nbsp;<a href="http://my company.com/"> my company</a></p>
       	   </div>
       	 </div>
       </div>
