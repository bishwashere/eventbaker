...
<!--here starts modification-->
	 ...
	 <article style="position: relative; width: 100%; opacity: 1;height: 300px;background-image:url('images/auditorium4.png');"> 
...
$sql = "SELECT * ".
       "FROM gallery where (category='auditorium')and(itemname like '%$s_key%' or city like '%$s_key%' or feature1 like '%$s_key%' or feature2 like '%$s_key%' or feature3 like '%$s_key%' or feature4 like '%$s_key%' or feature5 like '%$s_key%')".
...
//here ends the rating span
			...
			<li><p>add this product to wishlist and we will process your request</p></li>
				...
				echo "</div><!--box1 ends here-->   

			  
			  </div>";

if(!$s_key){
include('includes/audi_links.php');
}
...
{
   $last = $page - 2;
   echo "<a href=\"auditorium.php?page=$last&search_key=$s_key\" >Last</a> |";
   echo "<a href=\"auditorium.php?page=$page&search_key=$s_key\">Next</a>";
}
else if( $page == 0 )
{
   echo "<a href=\"auditorium.php?page=$page&search_key=$s_key\">Next</a>";
