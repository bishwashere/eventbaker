...
<title>Simple PayPal Integration code using PHP:Ready to use script</title>
<style>
.as_wrapper{
	margin:0 auto;
	width:500px;
...
<div class="as_wrapper">
    ...
    <tr>
        ...
        <td><input type="text" name="product_amount" value="50.00" /></td>
    </tr>
    <tr>
        <td><label>Payer First Name</label></td>
        <td><input type="text" name="payer_fname" value="firstname" /></td>
    </tr>
    <tr>
        <td><label>Payer Last Name</label></td>
        <td><input type="text" name="payer_lname" value="lastname" /></td>
    </tr>
    <tr>
        <td><label>Payer Address</label></td>
        <td><input type="text" name="payer_address" value="your street address" /></td>
    </tr>
    <tr>
        <td><label>Payer City</label></td>
        <td><input type="text" name="payer_city" value="your city here" /></td>
    </tr>
    <tr>
        <td><label>Payer State</label></td>
        <td><input type="text" name="payer_state" value="your state" /></td>
    </tr>    
    <tr>
        <td><label>Payer Zip</label></td>
        <td><input type="text" name="payer_zip" value="zipcode" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="payer_email" value="someone@something.com" /></td>
    </tr>
    <tr>
