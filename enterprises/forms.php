...
<head>
    ...
    <title>eventbaker.com||admin panel</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">EventBaker</a>
            </div>
            <!-- /.navbar-header -->
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-tasks fa-fw"></i> No.of Online Bookings:
<?php $result = mysqli_query($con,"select count(*) FROM bookings");
...
?>
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-tasks fa-fw"></i> No of offline booking
...
?>
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-tasks fa-fw"></i> No of booking this month
...
?>
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-tasks fa-fw"></i> Total no of bookings
